...
typealias TouchIDSuccessBlock = (Bool) -> Void
typealias TouchIDErrorBlock = (NSError) -> Void

open class TouchIDManager {

     func authenticateUser(reasonText: String, successBlock:@escaping TouchIDSuccessBlock,
